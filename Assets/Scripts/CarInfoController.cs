...
public class CarInfoController : MonoBehaviour
{
    ...
    public TMP_Text titleText; // Verander 'Text' naar 'TMP_Text'
    public TMP_Text descriptionText; // Verander 'Text' naar 'TMP_Text'
    ...
    public void ShowCarInfo(int carID)
    {
        ...
        switch (carID)
        {
            case 1:
                ...
                carImage.material.mainTexture = car1Image; // Gebruik de tekstuur (afbeelding) voor de eerste auto
                break;
            ...
            case 2:
                ...
                carImage.material.mainTexture = car2Image; // Gebruik de tekstuur (afbeelding) voor de tweede auto
                break;
            ...
            case 3:
                ...
                carImage.material.mainTexture = car3Image; // Gebruik de tekstuur (afbeelding) voor de derde auto
                break;
        }
    }
